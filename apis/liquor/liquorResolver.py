...
class liquor_detailPage(Resource):
    @Liquor.response(200, "Liquor exist", detail_result_response)
    @Liquor.response(404, "Not found")
    @Liquor.response(500, "Liquor doesn't exist")
    @Liquor.marshal_with(detail_result_response, mask=False)
...
class liquor_detailPage(Resource):
    @Cocktail.response(200, "Available cocktail_id",cocktail_result)
    @Cocktail.response(404, "Not found")
    @Cocktail.response(500, "Unavailable cocktail_id")
    @Cocktail.marshal_with(cocktail_result, mask=False)
