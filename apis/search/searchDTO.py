...
result_liquor_response = Search.model('result_liquor', {
...
result_cocktail_response = Search.model('result_cocktail', {
...
result_text_response = Search.model('result_text',{
    'liquor' : fields.Nested(result_liquor_response),
    'cocktail' : fields.Nested(result_cocktail_response)
})
